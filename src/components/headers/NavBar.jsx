            ...
            <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-6">
                <div className="flex px-4 items-center justify-between py-4">
                    ...
                    <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer pl-7 md:p-0 flex items-center">
                        <div className={``}>
                            <h1 className='text-2xl font-Cinzel  inline-flex gap-3  items-center font-bold'>Harmony Haven Yoga <img src="/yoga-logo.png" alt="" className='w-8 h-8' /></h1>
                            ...
                            <ul className="ml-10 flex items-center space-x-4 pr-4">
                                ...
                                ))}
                                {
                                    user ? null : isLogin ? <li>
                                        ...
                                        <NavLink
                                            to='/login'
                                            className={({ isActive }) => `font-bold ${isActive ? 'text-secondary' : `${navBg.includes('bg-transparent') ? 'text-white' : 'text-black dark:text-re'}`} hover:text-secondary duration-300`}
                                        >Login</NavLink></li>
                                }
                                {
